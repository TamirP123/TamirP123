...
| ---------------- | ------------------------------------------------------- | ---------- | ----- |
| **Harmonia Oasis Resorts** 🎨 | A creative front-end project showcasing UI/UX design.    | [Live](#)  | [Code](#) |
| **Stay Motivated** 💻 | Fullstack app using React, Node.js, and MongoDB.         | [Live](#)  | [Code](#) |
| **MotoHub** 🔍 | AI-powered web app designed to boost productivity.       | [Live](#)  | [Code](#) |
| **Employee Bubble** 🚀 | Interactive web app with GraphQL for real-time features. | [Live](#)  | [Code](#) |
